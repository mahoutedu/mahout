...
const words = ['big', 'bill', 'bin', 'bib', 'bit', 'did', 'dig', 'dim', 'dip', 'fib', 'fig', 'fill', 'fin', 'fit', 'fix', 'hid', 'hill', 'him', 'hit', 'if', 'in', 'it', 'kid', 'kill' , 'kiss', 'lid', 'lip', 'mill', 'pig', 'rib', 'rim', 'sit', 'six', 'will', 'win', 'zip', 'zig zag'];
