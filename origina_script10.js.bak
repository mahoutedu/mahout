...
const words = ['bag', 'bad', 'can', 'cab', 'cap', 'cat', 'dad', 'fan', 'fat', 'gas', 'hat', 'ham', 'had', 'jam', 'Lap', 'Lad', 'map', 'man', 'mat', 'nap', 'pan', 'pad', 'quack', 'rat', 'ran', 'rant', 'rag', 'rap', 'Sam', 'sad', 'tan', 'tap', 'tag', 'tax', 'wax', 'yak', 'zag', 'am', 'at', 'an', 'pass', 'mass', 'farm', 'day', 'say', 'bay', 'ray'];
